      ...
      <div style="display: flex; flex-direction: column; gap: 6px; font-size: 0.78rem;">
        ...
        <div style="display: flex; flex-direction: column; gap: 2px;">
          <div style="display:flex;align-items:center;gap:6px;">
            <button class="btn btn-secondary btn-xs" style="flex:1;justify-content: space-between; text-align: left; ${currentViewMode === 'combos' ? 'border-color: var(--accent-emerald); font-weight: 700;' : ''}" onclick="ModelClubView.toggleBranch('combos')">
        ...
        <!-- Blacklisted Models Sleep Mode Branch -->
        <div style="display: flex; flex-direction: column; gap: 2px; margin-top: 2px;">
          <button class="btn btn-secondary btn-xs" style="justify-content: space-between; text-align: left; border: 1px solid var(--border-color);" onclick="ModelClubView.toggleBranch('blacklisted')">
            <span><i class="fa-solid fa-moon" style="color: var(--accent-rose); margin-right: 6px;"></i> Sleep Mode</span>
            <i class="fa-solid ${expandedBranches.blacklisted ? 'fa-chevron-down' : 'fa-chevron-right'}" style="font-size: 0.65rem;"></i>
          </button>
          ${expandedBranches.blacklisted ? `<div style="display: flex; flex-direction: column; gap: 2px; padding-left: 10px; border-left: 1px dashed var(--border-color); margin-left: 6px; max-height: 120px; overflow-y: auto;">
            <button class="btn btn-secondary btn-xs" style="justify-content: flex-start; padding: 2px 6px; font-size: 0.7rem; border: none; background: transparent; color: var(--accent-rose); text-align: left;" onclick="ModelClubView.viewSleepingProviders(event)">• View Sleeping Providers</button>
          </div>` : ''}
        </div>
