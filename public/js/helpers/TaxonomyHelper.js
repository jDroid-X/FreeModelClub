...
class TaxonomyHelper {
  ...
  static SKILL_CATEGORIES = [
    { id: 'coding', name: 'Coding & Software Development', icon: 'fa-code', color: '#10b981',
    ...
    { id: 'reasoning', name: 'Reasoning & Complex Logic', icon: 'fa-brain', color: '#f59e0b',
    ...
    { id: 'general', name: 'General Knowledge & Language', icon: 'fa-comments', color: '#6366f1',
    ...
    { id: 'fast_chat', name: 'Fast Chat & Low Latency', icon: 'fa-bolt', color: '#06b6d4',
    ...
    { id: 'vision', name: 'Vision & Multimodal', icon: 'fa-eye', color: '#ec4899',
    ...
    { id: 'safety', name: 'Safety & Content Moderation', icon: 'fa-shield-halved', color: '#ef4444',
    ...
    { id: 'enterprise', name: 'Enterprise & Specialized', icon: 'fa-industry', color: '#8b5cf6',
